...
let businessNetworkName = 'srm-network';
let factory;
...
async function importCardForIdentity(cardName, identity) {
  ...
  businessNetworkName = 'srm-network';
...
module.exports = {
 ...
 registerMember: async function (cardId, accountNumber,firstName, lastName, email, phoneNumber) {
    try {
      ...
      //connect as admin
      businessNetworkConnection = new BusinessNetworkConnection();
      await businessNetworkConnection.connect('admin@srm-network');
      ...
      //disconnect
      await businessNetworkConnection.disconnect('admin@srm-network');
